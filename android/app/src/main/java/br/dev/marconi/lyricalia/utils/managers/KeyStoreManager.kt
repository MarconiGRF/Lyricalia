package br.dev.marconi.lyricalia.utils.managers
...
class KeyStoreManager {
    ...
    companion object {
        ...
        const val DATA_STORE_KEY_ENCRYPTABLES = "encriptables"
        ...
        suspend fun writeToPrefs(
            ...
            ds.edit { preferencesInstance ->
                preferencesInstance[preferenceKey] = value
            }

            Log.d("IF1001_P3_LYRICALIA", "Wrote preference to DataStore's ${preferenceKey.name} successfully.")
        }
       ...
       suspend fun readPrefs(
            ...
            val result: Flow<String> = ds.data.map { preferencesInstance ->
                preferencesInstance[preferenceKey]!!
            }.catch { exception ->
                Log.e("IF1001_P3_LYRICALIA", exception.message ?: "Unknown Error from Data Store")
            }
